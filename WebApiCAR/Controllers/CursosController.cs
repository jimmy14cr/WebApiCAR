...
namespace WebApiCAR.Controllers
{
    ...
    {
        private DbCoopeAlfaroRuizEntities db = new DbCoopeAlfaroRuizEntities();
        ...
        public IHttpActionResult PostCursos(Cursos cursos)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = cursos.IdCurso }, cursos);
        }
        ...
        {
            return db.Cursos.Count(e => e.IdCurso == id) > 0;
        }
    }
}